...
;~ 	$MaximumHatred = IniRead($skillHeros, "Run info", "MaximumHatred", $MaximumHatred)
;~ 	$MaximumDiscipline = IniRead($skillHeros, "Run info", "MaximumDiscipline", $MaximumDiscipline)
;~ 	$MaximumSpirit = IniRead($skillHeros, "Run info", "MaximumSpirit", $MaximumSpirit)
;~ 	$MaximumFury = IniRead($skillHeros, "Run info", "MaximumFury", $MaximumFury)
;~ 	$MaximumArcane = IniRead($skillHeros, "Run info", "MaximumArcane", $MaximumArcane)
